...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Growing Knowledge: il laboratorio di idroponica dell'IIS Caramuel Roncalli di Vigevano. Sostenibilità, ricerca scientifica e uso responsabile dell'acqua." },
      { property: "og:title", content: "Growing Knowledge — Coltivare piante per crescere idee" },
      { property: "og:description", content: "Laboratorio di idroponica dell'IIS Caramuel Roncalli — Vigevano." },
